...
class Hourly {
    ...
    Hourly({this.time, this.temperature2M, this.precipitationProbability, this.weatherCode, this.windSpeed10M});

    Hourly.fromJson(Map<String, dynamic> json) {
        time = json["time"] == null ? null : List<String>.from(json["time"]);
        temperature2M = json["temperature_2m"] == null ? null : List<int>.from(json["temperature_2m"]);
...
class HourlyUnits {
    ...
    HourlyUnits({this.time, this.temperature2M, this.precipitationProbability, this.weatherCode, this.windSpeed10M});
