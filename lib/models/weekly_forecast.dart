...
class Daily {
    ...
    Daily({this.time, this.weatherCode, this.temperature2MMax, this.temperature2MMin, this.sunrise, this.sunset});
    ...
    Daily.fromJson(Map<String, dynamic> json) {
        ...
        sunrise = json["sunrise"] == null ? null : List<String>.from(json["sunrise"]);
...
class DailyUnits {
    ...
    DailyUnits({this.time, this.weatherCode, this.temperature2MMax, this.temperature2MMin, this.sunrise, this.sunset});
